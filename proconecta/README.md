...
- **Notificações (sino no cabeçalho)**: técnico é avisado quando o administrador sugere alteração num dos seus registros, e também quando o administrador aprova um Laudo Técnico (é aí que o PDF fica disponível); administrador vê quantos itens aguardam aprovação. Clicar num item leva direto para a tela correspondente.
